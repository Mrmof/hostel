						...
						<div class="row">
							<div class="col-xxl-3 col-sm-4 col-12">
								<div class="stats-tile">
									...
									<div class="sale-details">
										<h5>Occupants</h5>
										<h4 class="text-blue"><?=$userdetails->users()?></h4>
									</div>
								</div>
							</div>
							<div class="col-xxl-3 col-sm-4 col-12">
								<div class="stats-tile">
									...
									<div class="sale-details">
										<h5>Applications</h5>
										<h4 class="text-blue"><?=$application->applications()?></h4>
									</div>
								</div>
							</div>
							<div class="col-xxl-3 col-sm-4 col-12">
								<div class="stats-tile">
									...
									<div class="sale-details">
										...
										<h4 class="text-blue"><?=$application->pendingapplications()?></h4>
									</div>
								</div>
							</div>
							<div class="col-xxl-3 col-sm-4 col-12">
								<div class="stats-tile">
									...
									<div class="sale-details">
										<h5>Allocations</h5>
										<h4 class="text-green"><?=$allocation->countallocations()?></h4>
									</div>
								</div>
							</div>
							<div class="col-xxl-3 col-sm-4 col-12">
								<div class="stats-tile">
									...
									<div class="sale-details">
										<h5>Hostels</h5>
										<h4 class="text-green"><?=$hostel->hostels()?></h4>
									</div>
								</div>
							</div>
							<div class="col-xxl-3 col-sm-4 col-12">
								<div class="stats-tile">
									...
									<div class="sale-details">
										<h5>Total Rooms</h5>
										<h4 class="text-green"><?=$hostel->rooms()?></h4>
									</div>
								</div>
							</div>
							<!-- <div class="col-xxl-3 col-sm-4 col-12">
							...
							<div class="col-xxl-3 col-sm-4 col-12">
								<div class="stats-tile">
									...
									<div class="sale-details">
										<h5>Resolved Complians</h5>
										<h4 class="text-green"><?=$message->resolvedmessage()?></h4>
									</div>
								</div>
							</div>
							<div class="col-xxl-3 col-sm-4 col-12">
								<div class="stats-tile">
									...
									<div class="sale-details">
										<h5>Pending Complians</h5>
										<h4 class="text-green"><?=$message->pendingmessage()?></h4>
									</div>
								</div>
							</div>
