		...
		<div class="main-container">
			...
			<div class="content-wrapper-scroll">
				...
				<div class="content-wrapper">
					...
					<!-- Row start -->
					<form action="<?= ROOT_URL ?>php/controller/compliants.php" method="post">
					<div class="row">
						<h3 class="text-center">Complians Section</h3>
						<small class="text-center text-danger">
							<?php 
								if(isset($_SESSION['compliants_error'])){
									echo $_SESSION['compliants_error'];
									unset($_SESSION['compliants_error']);
								}
							?>
						</small>
							...
							<div class="row">
								...
								<div class="col-12">
									<div class="m-2">
										...
										<textarea name="message" id="" cols="10" rows="5" class="form-control" placeholder="Message..." style="resize: none"></textarea>
									</div>
								</div>
							</div>
							<button type="submit" class="btn btn-success ms-auto d-block">Send</button>
						</div>
